...
// --------------------------------------------------------------------------------
//
// ASCOM Telescope driver for Old_ArduinoUnoEQ32
...
namespace ASCOM.Old_ArduinoUnoEQ32
{
    //
    // Your driver's DeviceID is ASCOM.Old_ArduinoUnoEQ32.Telescope
    //
    // The Guid attribute sets the CLSID for ASCOM.Old_ArduinoUnoEQ32.Telescope
    // The ClassInterface/None addribute prevents an empty interface called
    // _Old_ArduinoUnoEQ32 from being created and used as the [default] interface
    //
    ...
    public class Telescope : ITelescopeV3
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.Old_ArduinoUnoEQ32.Telescope";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "Old_ArduinoUnoEQ32";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Old_ArduinoUnoEQ32"/> class.
        ...
        public Telescope()
        {
            ...
            tl = new TraceLogger("", "Old_ArduinoUnoEQ32");
        ...
        public string DriverInfo
        {
            get
            {
                ...
                string driverInfo = "Old_ArduinoUnoEQ32 Driver. Version: " + String.Format(CultureInfo.InvariantCulture, "{0}.{1}", version.Major, version.Minor);
        ...
        public string Name
        {
            get
            {
                string name = "Old_ArduinoUnoEQ32 Driver";
